...
INSERT INTO alunos (
    ...
    (5, 'Fernanda Costa', '56789012345', '1997-09-08', 'F', '(65) 99999-1005', 'fernanda.costa@email.com', 'Rua Sao Jose', '77', NULL, 'Rondonopolis', 'MT', '78700000'),
    (6, 'Gabriel Rocha', '67890123456', '2002-12-20', 'M', '(65) 99999-1006', 'gabriel.rocha@email.com', 'Avenida Central', '901', 'Bloco B', 'Sinop', 'MT', '78550000')
...
INSERT INTO planos (id, modalidade_id, nome, valor_mensal, ativo) VALUES
    ...
    (5, 5, 'Boxe Mensal', 129.90, TRUE),
    (6, 6, 'Yoga Mensal', 89.90, FALSE),
    (7, 1, 'Musculacao Trimestral', 269.70, TRUE)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO matriculas (id, aluno_id, data_matricula, dia_vencimento, data_encerramento, status) VALUES
    ...
    (5, 5, '2026-05-12', 12, NULL, 'ATIVA'),
    (6, 6, '2026-06-20', 20, '2026-07-10', 'CANCELADA')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO matriculas_modalidades (
    ...
    (5, 5, 5, 7, 5, '2026-05-12', NULL),
    (6, 6, 6, 9, 6, '2026-06-20', '2026-07-10')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO faturas_matriculas (
    ...
    (7, 5, '2026-07-12', 129.90, NULL, NULL, 'ABERTA'),
    (8, 5, '2026-08-12', 129.90, NULL, NULL, 'ABERTA'),
    (9, 6, '2026-07-20', 89.90, NULL, '2026-07-10', 'CANCELADA')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO assiduidade (id, matricula_id, data_entrada, data_saida) VALUES
    ...
    (6, 5, '2026-07-14 18:40:00', '2026-07-14 20:00:00'),
    (7, 5, '2026-07-16 18:35:00', NULL)
ON CONFLICT (id) DO NOTHING;

SELECT setval(pg_get_serial_sequence('alunos', 'id'), COALESCE((SELECT MAX(id) FROM alunos), 1));
SELECT setval(pg_get_serial_sequence('modalidades', 'id'), COALESCE((SELECT MAX(id) FROM modalidades), 1));
SELECT setval(pg_get_serial_sequence('graduacoes', 'id'), COALESCE((SELECT MAX(id) FROM graduacoes), 1));
SELECT setval(pg_get_serial_sequence('planos', 'id'), COALESCE((SELECT MAX(id) FROM planos), 1));
SELECT setval(pg_get_serial_sequence('matriculas', 'id'), COALESCE((SELECT MAX(id) FROM matriculas), 1));
SELECT setval(pg_get_serial_sequence('matriculas_modalidades', 'id'), COALESCE((SELECT MAX(id) FROM matriculas_modalidades), 1));
SELECT setval(pg_get_serial_sequence('faturas_matriculas', 'id'), COALESCE((SELECT MAX(id) FROM faturas_matriculas), 1));
SELECT setval(pg_get_serial_sequence('assiduidade', 'id'), COALESCE((SELECT MAX(id) FROM assiduidade), 1));
